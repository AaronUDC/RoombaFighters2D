...
class TextoGameOver(TextoGUI):
    ...
    def __init__(self, pantalla, posicion):
        ...
        TextoGUI.__init__(self, pantalla, fuente, (200, 0, 0), 'VICTORY', posicion)

    def accion(self):
        return

class PantallaVictory(PantallaGUI):
...
class Victory(EscenaPygame):
    ...
    def __init__(self, director, fondo):
        ...
        self.listaPantallas.append(PantallaVictory(self))
